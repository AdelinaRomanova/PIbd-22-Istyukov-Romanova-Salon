...
namespace BeautySalonViewEmployee
{
    ...
    public partial class WindowDistribution : Window
    {
        ...
        public WindowDistribution(IDistributionLogic logic)
        {
            InitializeComponent();
            this._logic = logic;
        }
        ...
        private void WindowDistribution_Loaded(object sender, RoutedEventArgs e)
        {
            if (id.HasValue)
            {
                try
                {
                    DistributionViewModel view = _logic.Read(new DistributionBindingModel { Id = id.Value })?[0];
                    if (view != null)
                    {
        ...
        private void buttonSave_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                _logic.CreateOrUpdate(new DistributionBindingModel
                {
                    Id = id,
